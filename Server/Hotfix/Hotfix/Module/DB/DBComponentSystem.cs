...
namespace ET.Server
{
    ...
    {
        [EntitySystem]
        private static void Awake(this DBComponent self, string dbConnection, string dbName, string mysqlConnStr)
        {
            self.mongoClient = new MongoClient(dbConnection + "?maxPoolSize=20000&retryWrites=true");
